...
proc compose { } {
    ...
    add_instance custom_leds_0 custom_leds 1.0
    ...
    add_connection clk_0.clk custom_leds_0.clock clock

    add_connection clk_0.clk hps_0.f2h_sdram0_clock clock

    add_connection clk_0.clk hps_0.h2f_lw_axi_clock clock

    add_connection clk_0.clk_reset custom_leds_0.reset reset

    add_connection clk_0.clk_reset hps_0.f2h_cold_reset_req reset

    add_connection clk_0.clk_reset hps_0.f2h_debug_reset_req reset

    add_connection clk_0.clk_reset hps_0.f2h_warm_reset_req reset

    add_connection hps_0.h2f_lw_axi_master custom_leds_0.s0 avalon
    set_connection_parameter_value hps_0.h2f_lw_axi_master/custom_leds_0.s0 arbitrationPriority {1}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/custom_leds_0.s0 baseAddress {0x0000}
    set_connection_parameter_value hps_0.h2f_lw_axi_master/custom_leds_0.s0 defaultConnection {0}
    ...
    add_interface leds2 conduit end
    set_interface_property leds2 EXPORT_OF custom_leds_0.conduit_end
